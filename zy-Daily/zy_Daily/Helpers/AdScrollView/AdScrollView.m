...
- (void)setAdTitleArray:(NSArray *)adTitleArray withShowStyle:(AdTitleShowStyle)adTitleStyle
{
    ...
    _leftAdLabel.frame = CGRectMake(10, UISCREENHEIGHT - 80, UISCREENWIDTH - 20, 60);
    [_leftImageView addSubview:_leftAdLabel];
    _centerAdLabel.frame = CGRectMake(10, UISCREENHEIGHT - 80, UISCREENWIDTH - 20, 60);
    [_centerImageView addSubview:_centerAdLabel];
    _rightAdLabel.frame = CGRectMake(10, UISCREENHEIGHT - 80, UISCREENWIDTH - 20, 60);
    ...
    _leftAdLabel.font = [UIFont systemFontOfSize:20];
    _centerAdLabel.font = [UIFont systemFontOfSize:20];
    _rightAdLabel.font = [UIFont systemFontOfSize:20];
    
    _leftAdLabel.numberOfLines = 0;
    _centerAdLabel.numberOfLines = 0;
    _rightAdLabel.numberOfLines = 0;
    
    _leftAdLabel.backgroundColor = [UIColor colorWithRed:59/255.0 green:59/255.0 blue:59/255.0 alpha:0.2];
    _centerAdLabel.backgroundColor = [UIColor colorWithRed:59/255.0 green:59/255.0 blue:59/255.0 alpha:0.2];
    _rightAdLabel.backgroundColor = [UIColor colorWithRed:59/255.0 green:59/255.0 blue:59/255.0 alpha:0.2];
...
- (void)setPageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle
{
    ...
    else if (PageControlShowStyle == UIPageControlShowStyleCenter)
    {
        ...
        _pageControl.center = CGPointMake(UISCREENWIDTH/2.0, HIGHT+UISCREENHEIGHT - 10 - 64);
    }
    else
    {
